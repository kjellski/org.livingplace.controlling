package org.livingplace.controlling.knowledge.api.old.drools;
...
public class DroolsManager extends Thread {
    ...
    private Logger logger = Logger.getLogger(DroolsManager.class.getName());
    ...
    public void run() {
        ...
        try {
            ...
            logger.info("Interrupted the " + this.getClass().getName() + ", action interrupted: " + e.getMessage()
                    + ".");
        } finally {
            this.shutdown();
        }

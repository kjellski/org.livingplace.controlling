...
public final class JarResources
{
    ...
    public String ResourcesToString() {
        ...
        Iterator<Entry<String, byte[]>> i = this.htJarContents.entrySet().iterator();
        while (i.hasNext()) {
            Entry<String, byte[]> entry = i.next();
            sb.append(entry.getKey() + " -> " + new String(entry.getValue(), Charset.defaultCharset()) + "\n");
        }
    ...
    // /**
    // * Is a test driver. Given a jar file and a resource name, it trys to extract the resource and then tells us
    // whether
    // * it could or not.
    // *
    // * <strong>Example</strong> Let's say you have a JAR file which jarred up a bunch of gif image files. Now, by
    // using
